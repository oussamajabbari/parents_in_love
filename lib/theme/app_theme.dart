...
class AppTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xFF0061ff),
      onPrimary: Color(0xFFFFFFFF),
      primaryContainer: Color(0xFF50b1ff),
      onPrimaryContainer: Color(0xFF0039d7),
      secondary: Color(0xFFe81cff),
      onSecondary: Color(0xFFFFFFFF),
      secondaryContainer: Color(0xFFff6cff),
      onSecondaryContainer: Color(0xFFc000d7),
      tertiary: Color(0xFFe70d0d),
      onTertiary: Color(0xFFFFFFFF),
      tertiaryContainer: Color(0xFFff5d5d),
      onTertiaryContainer: Color(0xFFbf0000),
      ...
      inversePrimary: Color(0xFF004deb),
      primaryFixed: Color(0xFF50b1ff),
      onPrimaryFixed: Color(0xFF0025c3),
      primaryFixedDim: Color(0xFF3c9dff),
      onPrimaryFixedVariant: Color(0xFF004deb),
      secondaryFixed: Color(0xFFff6cff),
      onSecondaryFixed: Color(0xFFac00c3),
      secondaryFixedDim: Color(0xFFff58ff),
      onSecondaryFixedVariant: Color(0xFFd408eb),
      tertiaryFixed: Color(0xFFff5d5d),
      onTertiaryFixed: Color(0xFFab0000),
      tertiaryFixedDim: Color(0xFFff4949),
      onTertiaryFixedVariant: Color(0xFFd30000),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFF004deb),
      surfaceTint: Color(0xFF004deb),
      onPrimary: Color(0xFFFFFFFF),
      primaryContainer: Color(0xFF0025c3),
      onPrimaryContainer: Color(0xFFFFFFFF),
      secondary: Color(0xFFd408eb),
      onSecondary: Color(0xFF000000),
      secondaryContainer: Color(0xFFac00c3),
      onSecondaryContainer: Color(0xFFFFFFFF),
      tertiary: Color(0xFFd30000),
      onTertiary: Color(0xFFFFFFFF),
      tertiaryContainer: Color(0xFFab0000),
